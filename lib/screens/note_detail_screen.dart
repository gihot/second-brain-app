...
class _NoteDetailScreenState extends State<NoteDetailScreen> {
  ...
  void initState() {
    ...
    _contentCtrl = TextEditingController(
      text: _stripFrontmatter(note?.content ?? ''),
    );
  ...
  void _openConnection(String filePath) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => NoteDetailScreen(noteId: target.id)),
    );
  }
                  ...
                  children: [
                    ...
                    if (_editing && _thoughtType == ThoughtType.reminder) ...[
                      ...
                      ReminderNode(
                        ...
                        note.remindAt != null) ...[
                      const SizedBox(height: BrainSpacing.sm),
                      ReminderNode(formatted: _formatRemindAt(note.remindAt!)),
                    ],
                        ...
                        ..._connections.map(
                          (c) => Padding(
                            ...
                            child: ConnectionCard(
                              targetTitle:
                                  (c['title'] as String?)?.trim().isNotEmpty ==
                                      true
                                  ? c['title'] as String
